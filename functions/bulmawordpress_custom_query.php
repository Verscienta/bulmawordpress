...
function bulmawordpress_custom_query($args = array())
{
	...
	if ($post_class == '') {
		$bulmawordpress_post_class = $post_type;
	} else {
		$bulmawordpress_post_class = $post_class;
	}

	$output = '<div class="'.$bulmawordpress_post_class.'">';
