...
function bulmawordpress_home_link($class)
{
...
function bulmawordpress_blog_description($class)
{
...
function bulmawordpress_skip_link_screen_reader_text()
{
...
function bulmawordpress_menu_toggle()
{
	$output = '
...
function bulmawordpress_copyright_link($author = 'bulmawordpress', $url = 'http://bulmawordpress.com')
{
	$output = '
...
function bulmawordpress_the_title($class = 'is-3', $link = TRUE)
{
	$heading = _bulmawordpress_convert_heading($class);
...
function _bulmawordpress_convert_heading($class)
{
	switch ($class) {
		case 'is-1':
		$heading = 'h1';
...
function bulmawordpress_get_comments()
{
